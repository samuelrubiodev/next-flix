    ...
    <div className="relative flex justify-center pt-5 w-full h-full">
      ...
      <div className="ml-0 md:ml-8 text-white flex flex-col gap-4">
        ...
        <div className="flex flex-row">
          <p className="mt-5 text-zinc-300 font-bold text-2xl p-8 rounded-full border-2 border-green-700 flex justify-center items-center bg-zinc-600 hover:bg-zinc-700
